...
exports.web3Provider_ws2 = process.env.WEB3_PROVIDER_WS2 ||  'wss://ropsten.infura.io/ws';

exports.web3Provider_http = process.env.WEB3_PROVIDER_HTTP ||  'https://ropsten.infura.io/JCs6qYLCphYtcJVWWUpR';

exports.gasMultiplier =  process.env.GAS_MULTIPLIER || 1;


exports.currentWeb3WebsocketProvider = exports.web3Provider_ws;

exports.getAlternatingWebSocketProvider = () => {
	exports.currentWeb3WebsocketProvider = (exports.currentWeb3WebsocketProvider == exports.web3Provider_ws) ? exports.web3Provider_ws2 : exports.web3Provider_ws;
	return 	exports.currentWeb3WebsocketProvider;
};
